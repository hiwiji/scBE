...
public class PrintWriterTest {
    ...
    public static void main(String[] args) {
        ...
        // 기존 FileWriter
        String filename = "src/exercise/chapter_56/output_print.txt";
        ...
        try (FileWriter fileWriter = new FileWriter(filename)) {
            ...
            String formattedValue =
                    String.format("format() 메서드도 형식화된 문자열을 출력할 수 있습니다. 값: %.2f\n", value);
        ...
        //보조스트림 이용 (print)
        String filename2 = "src/exercise/chapter_56/output_print2.txt";
