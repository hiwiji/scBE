...
public class AirReservationService {
    ...
    public List<Ticket> findUserFavoritePlaceTickets(Integer userId, String ticketType) {
        ...
        if(airlineTickets.isEmpty()) throw new NotFoundException
                ("해당 likePlace: " + likePlace + "와 TicketTipe: " + ticketType + "에 해당하는 항공권을 찾을 수 없습니다.");
    ...
    public ReservationResult makeReservation(ReservationRequest reservationRequest) {
        ...
        // 1. Passenger
        Passenger passenger = passengerReposiotry.findPassengerByUserId(userId).orElseThrow(
                                                      () -> new NotFoundException("요청하신 userId: " + userId + "에 해당하는 Passenger를 찾을 수 없습니다."));
        ...
        if(airlineTicketAndFlightInfos.isEmpty()) throw new NotFoundException
                ("AirlineTicket Id " + airlineTicketId + "에 해당하는 항공편과 항공권을 찾을 수 없습니다." );
